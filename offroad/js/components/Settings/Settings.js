                ...
                <ScrollView
                    ...
                    <X.Table color='darkBlue'>
                        <X.TableCell
                            ...
                            description='ドライバー側のカメラを見ながらデバイスの取り付け位置を確認し、ドライバー監視を最適化します。(エンジンを切る必要があります)'
                        ...
                        <X.TableCell
                            ...
                            descriptionExtra={
                              <X.Text color='white' size='tiny'>
                                  comma.ai が保守・サポートしておらず、標準の安全モデルを満たすことが確認されていないオープンソースコミュニティの機能を使用してください。これらの機能には、コミュニティがサポートしている車やコミュニティがサポートしているハードウェアなどがあります。これらの機能を使用する際には特に注意してください。{'\n'}
                              </X.Text>
                            }
